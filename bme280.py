...
class bme280(object):
	...
	def readData(self):
		...
		try:
			...
			ret['temperature'] = self.compensate_T(temp_raw)
			ret['pressure']    = self.compensate_P(pres_raw)
			ret['humidity']    = self.compensate_H(hum_raw)
		finally:
			return(ret)
	...
	def compensate_P(self, adc_P):
		...
		return {"value":pressure/100, "unit":"hPa", "sensor":"BME280"}
	...
	def compensate_T(self, adc_T):
		...
		return {"value":temperature, "unit":"celsius", "sensor":"BME280"}
	...
	def compensate_H(self, adc_H):
		...
		return {"value":var_h, "unit":"%", "sensor":"BME280"}
